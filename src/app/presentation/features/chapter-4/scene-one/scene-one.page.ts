...
export class SceneOnePage implements OnInit, AfterViewInit, OnDestroy {
  ...
  @ViewChild('cap4Esc1Narrator') audioPlayer: ElementRef<HTMLAudioElement>;
  ...
  public onRepeatScene() {
    this._utilService.redirectToUrl(ROUTES.CHAPTER_4_SCENE_1);
  }
